...
- Keep the dependency footprint small: standard library, `aws-sdk-go-v2`, `prometheus/client_golang` (metrics only), and `golang.org/x/sync` (request coalescing). New third-party dependencies need a good reason.
